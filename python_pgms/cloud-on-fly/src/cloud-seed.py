...
glusterfs_version="3.0.3rc1" # default gluster version
pdsh_user="root@"
...
cloud_export_dir="/mnt/export/gluster/cloud/export/"
cloud_spec_dir="/mnt/export/gluster/cloud/specs_dir/"
	...
	def start_server(self):
		try:
				...
				#Now vol files are available servers.So start it
					...
					pidfile= "  -L DEBUG --pid-file=/tmp/server.pid"
	...
	def start_client(self):
		...
		try:
				...
				nfsserver=" "
					...
					if skip != 1:
						pidfile= "  -L DEBUG --pid-file=/tmp/client.pid"
